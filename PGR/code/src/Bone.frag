...
vec3 CalcDirLight(DirLight light, vec3 normal, vec3 viewDir)
{
    ...
    vec3 ambient = light.ambient * vec3(0.86f, 0.667f, 0.576f);
    vec3 diffuse = light.diffuse * diff * vec3(0.86f, 0.667f, 0.576f);
    vec3 specular = light.specular * spec * vec3(0.86f, 0.667f, 0.576f);
